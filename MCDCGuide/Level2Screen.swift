        ...
        GeometryReader { geometry in
            VStack(spacing: 0) {
                ...
                ZStack {
                    ...
                    ForEach(mapController.l2Pins) { pin in
                        Button(action: {
                            ...
                            if let matchingGallery = galleryController.L2Galleries.first(where: { $0.label == pin.galleryLabel }) {
                ...
                VStack (alignment: .leading) {
                        ...
                        Text("Why do you think the aurora borealis only appears near the North and South Poles?")
